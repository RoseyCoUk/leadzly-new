...
- [ ] **META-01**: Site includes `<link rel="canonical" href="https://leadzly.co/">` in `<head>`
- [ ] **META-02**: Site includes `<meta name="robots" content="index, follow">` in `<head>`
- [ ] **META-03**: Site includes all 4 Twitter Card meta tags (`twitter:card`, `twitter:title`, `twitter:description`, `twitter:image`)
...
- [ ] **SCHEMA-01**: Organization + LocalBusiness JSON-LD block in `<head>` (name, URL, logo, contactPoint, areaServed UK/NI)

...
- [x] **PERF-04**: Floating CTA inject causes zero CLS (container pre-reserved or transition adjusted)
- [x] **PERF-05**: `page.css` minified — served as minified file, version-bumped
